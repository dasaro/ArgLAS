...
| `zero_shot/` | the out-of-corpus check of the frozen learned semantics σ_H on independent published stimuli (Cramer & Guillaume 2018, 2019; Rahwan et al. 2010): frozen program, transcribed stimuli/responses, evaluation script and results; see `zero_shot/README.md` |
